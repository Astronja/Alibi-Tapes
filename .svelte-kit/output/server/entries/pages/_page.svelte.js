...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		if (currentView === "intro") {
			...
			$$renderer.push("<!--[2-->");
			$$renderer.push(`<div class="verdict-page svelte-1uha8ag"><h2 class="svelte-1uha8ag">FINAL VERDICT</h2> <div${attr_class("score svelte-1uha8ag", void 0, { "hidden": finalChoice })}><p class="svelte-1uha8ag">You correctly identified <strong class="svelte-1uha8ag">${escape_html(getScore())}</strong> out of <strong class="svelte-1uha8ag">7</strong> fragments.</p></div> <div${attr_class("bias-analysis svelte-1uha8ag", void 0, { "hidden": finalChoice })}><p class="svelte-1uha8ag">${escape_html(getBiasAnalysis())}</p></div> <div class="final-choice svelte-1uha8ag"><p class="choice-prompt svelte-1uha8ag">Based on your analysis, what is your verdict on Elena Clark?</p> <div id="choice-buttons" class="choice-buttons svelte-1uha8ag"><button class="choice-btn yes svelte-1uha8ag">YES – SHE USED AI</button> <button class="choice-btn no svelte-1uha8ag">NO – SHE IS INNOCENT</button> <button class="choice-btn insufficient svelte-1uha8ag">INSUFFICIENT EVIDENCE</button></div></div> <div id="outcome-container" class="outcome-container svelte-1uha8ag" style="display: none;">`);
			if (finalChoice === "AI") {
				$$renderer.push("<!--[0-->");
				$$renderer.push(`<div class="court-ruling svelte-1uha8ag"><div class="ruling-header svelte-1uha8ag">OFFICIAL RULING</div> <p class="svelte-1uha8ag">The literary board has determined that Elena Clark utilized artificial intelligence in the composition of her novel "Confession". All associated royalties are forfeited, and the work has been stricken from her official bibliography. The investigation did not uncover the identity fraud.</p></div> <div class="star-rating svelte-1uha8ag"><span class="star svelte-1uha8ag" style="animation-delay: 0s">★</span><span class="star svelte-1uha8ag" style="animation-delay: 0.15s">★</span><span class="star svelte-1uha8ag" style="animation-delay: 0.3s">☆</span></div> <div class="thoughtful-comment svelte-1uha8ag"><p class="svelte-1uha8ag">"You caught the AI, but left with a story unrevealed, perhaps forever."</p></div>`);
			} else if (finalChoice === "INNOCENT") {
				$$renderer.push("<!--[1-->");
				$$renderer.push(`<div class="court-ruling svelte-1uha8ag"><div class="ruling-header svelte-1uha8ag">OFFICIAL RULING</div> <p class="svelte-1uha8ag">Elena Clark is acquitted of all AI-plagiarism charges. The evidence was deemed inconclusive, and her literary reputation remains intact. No further investigation into the authorship of the fragments will be pursued.</p></div> <div class="star-rating svelte-1uha8ag"><span class="star svelte-1uha8ag" style="animation-delay: 0s">★</span><span class="star svelte-1uha8ag" style="animation-delay: 0.15s">☆</span><span class="star svelte-1uha8ag" style="animation-delay: 0.3s">☆</span></div> <div class="thoughtful-comment svelte-1uha8ag"><p class="svelte-1uha8ag">"You trusted the human warmth, but that warmth was a lie. You have never noticed."</p></div>`);
			} else if (finalChoice === "INSUFFICIENT") {
				$$renderer.push("<!--[2-->");
				$$renderer.push(`<div class="court-ruling svelte-1uha8ag"><div class="ruling-header svelte-1uha8ag">OFFICIAL RULING</div> <p class="svelte-1uha8ag">Due to insufficient evidence, no formal charges are filed regarding AI-Plagiarism. However, in a closed hearing, Marisol Clark submitted a written confession. She admitted to accidentally causing Elena Clark's death on April 4, 2022, and subsequently using AI to assume her sister's identity. The confession has been sealed. Marisol Clark awaits a separate trial for involuntary manslaughter and fraud.</p></div> <div class="star-rating svelte-1uha8ag"><span class="star svelte-1uha8ag" style="animation-delay: 0s">★</span><span class="star svelte-1uha8ag" style="animation-delay: 0.15s">★</span><span class="star svelte-1uha8ag" style="animation-delay: 0.3s">★</span></div> <div class="thoughtful-comment svelte-1uha8ag"><p class="svelte-1uha8ag">"You weren't sure. That doubt was the truth. You let the confession speak."</p></div>`);
			} else $$renderer.push("<!--[-1-->");
			$$renderer.push(`<!--]--> <button class="restart-btn svelte-1uha8ag">RESTART INVESTIGATION</button></div></div>`);
